...
for dataset_name in dataset_names:
    ...
    for random_state in range(100):
        ...
        df_observed[["compound", "protein", "label", "weight"]].to_csv("../../data/maked/bias/" + str(random_state) + "/train_" + dataset_name + "_link_strong.csv", index=None)
        df_test.to_csv("../../data/maked/bias/" + str(random_state) + "/test_" + dataset_name + "_link_strong.csv", index=None)
