...
for dataset_name in dataset_names:
    for random_state in range(100):
        train_filename = "../../data/maked/bias/" + str(random_state) + "/train_" + dataset_name + "_link_freq.csv"
        test_filename = "../../data/maked/bias/" + str(random_state) + "/test_" + dataset_name + "_link_freq.csv"
        ...
        with open("./" + dataset_name+"_baseline_link_freq.txt", "a") as f:
            f.write(str(score_baseline) +"\n")
        with open("./" + dataset_name+"_propose_link_freq.txt", "a") as f:
