...
"""Hyperparameters."""
DATASET="human" # DATASET=celegans
radius="2"
ngram="3"
dim=10
layer_gnn=3
...
if __name__ == "__main__":
    ...
    file_seed = input("seed \n")

    """Load preprocessed data."""
    dir_input = ('./data/' + DATASET + '/input/radius' + radius + '_ngram' + ngram + '/input/' + file_seed + "/")
    dir_test = ('./dat/' + DATASET + '/input/radius' + radius + '_ngram' + ngram + '/test/' + file_seed + "/")
    ...
    compounds_test = load_tensor(dir_test + 'compounds', torch.LongTensor)
    adjacencies_test = load_tensor(dir_test + 'adjacencies', torch.FloatTensor)
    proteins_test = load_tensor(dir_test + 'proteins', torch.LongTensor)
    interactions_test = load_tensor(dir_test + 'interactions', torch.LongTensor)
    ...
    """Output files."""
    file_AUCs = '../../output/result/AUCs_' + file_seed + '.txt'
    file_model = '../../output/model/model_' + file_seed
